...
const styles = {
  main: {
    minHeight: "100vh",
    background: "linear-gradient(to bottom, rgba(30, 58, 95, 0.3), rgba(15, 23, 42, 0.4)), url('https://raw.githubusercontent.com/Pvrolomx/canal/main/HCRPV/HCRPV%20Fondo.png') center/cover no-repeat fixed",
